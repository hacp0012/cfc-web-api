  ...
  >
    <div class="container">
      <a class="navbar-brand pe-4 fs-4" href="/">
        <img src="/logo.png" class="bi bi-layers-half" height="54" />
        <span class="ms-1 fw-bolder">CFC</span>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a
          href="https://templatedeck.com/stride-html-template.html"
      ...
      <div class="container position-relative">
        ...
        <div class="row">
          <div class="col-lg-7 py-vh-6 position-relative" data-aos="fade-right">
            ...
            <Link href="/temp/login" class="btn btn-dark btn-xl shadow me-3 rounded-0 my-5"
              >Connectez-vous
            </Link>
          </div>
        </div>
        ...
        <div class="row d-flex justify-content-end">
          <div class="col-lg-8" data-aos="fade-down">
            <h2 class="display-6">
              ...
              more than three, but we think three is a reasonable good number of
              good stuff.
            </h2>
          </div>
        </div>
            ...
            <div class="row gx-5 d-flex">
              <div class="col-md-11">
                <div
                  ...
                  data-aos="fade-right"
                  style="
                    background-image: url(/assets/img/webp/people15.webp);
                    --bs-aspect-ratio: 50%;
                  "
                ></div>
              </div>
              <div class="col-md-5 offset-md-1">
                <div
                  ...
                  data-aos="fade-up"
                  style="
                    background-image: url(/assets/img/webp/interior42.webp);
                  "
                ></div>
              </div>
              <div class="col-md-6">
                <div
                  ...
                  data-aos="fade-left"
                  style="
                    background-image: url(/assets/img/webp/people4.webp);
                    --bs-aspect-ratio: 150%;
                  "
                ></div>
              </div>
            ...
            <div class="row">
              <div class="col-12">
                <h2 class="display-6 mb-5" data-aos="fade-down">
                  There are some important numbers for us. They are just numbers
                  without any meaning, but we just love them.
                </h2>
              </div>
          ...
          <div class="col-12">
            ...
            >
              <div class="col-md-2" data-aos="fade-up">
                <img
                  src="/assets/img/webp/interior37.webp"
              ...
              <div class="col-md-2" data-aos="fade-up" data-aos-delay="200">
                <img
                  src="/assets/img/webp/people1.webp"
              ...
              <div class="col-md-3" data-aos="fade-up" data-aos-delay="400">
                <img
                  src="/assets/img/webp/people2.webp"
                  class="img-fluid rounded shadow"
                  alt="nice gallery image"
                  width="844"
                  height="1054"
              ...
              <div class="col-md-3" data-aos="fade-up" data-aos-delay="600">
                <img
                  src="/assets/img/webp/interior29.webp"
                  class="img-fluid rounded shadow"
                  alt="nice gallery image"
                  width="844"
                  height="562"
              ...
              <div class="col-md-2" data-aos="fade-up" data-aos-delay="800">
                <img
                  src="/assets/img/webp/people23.webp"
                  class="rounded shadow img-fluid"
                  alt="nice gallery image"
                  width="512"
                  height="341"
        ...
        <div class="col-md-7" data-aos="fade-left">
          <blockquote>
            <div class="fs-4 my-3 fw-light pt-4 border-bottom pb-3">
              ...
              something super awesome about it only". But no. Its a really
              strange place to work with creepy people all around. They do some
              computer stuff I don´t understand. But I wear expensive Glasses
              and a Patagonia Hoodie. So I´am fine with it.”
            </div>
            <img
              src="/assets/img/webp/person11.webp"
              width="64"
              height="64"
      ...
      <div class="container py-vh-6">
        <div class="row d-flex justify-content-center">
          <div class="col-12 col-lg-10 col-xl-8 text-center">
            ...
            <p class="lead">
              Our spaces and offices are soooooo lovely, no one would give us a
              negative rating! And look at these trustworthy avatar pictures!
              Trust us!
            </p>
          </div>
                  ...
                  <div class="card-body">
                    ...
                    <blockquote class="blockquote">
                      <p>
                        ...
                        because they don´t pay me more money anymore if I don´t
                        say it..."
                      </p>
                    </blockquote>
                    <div class="d-flex justify-content-between border-top pt-3">
                      ...
                      <img
                        src="/assets/img/webp/person9.webp"
                        width="48"
                        height="48"
              ...
              <div class="col-12 col-lg-6 col-xl-4">
                <div class="card p-4 shadow mt-3 border-0" data-aos="fade-down">
                  <div class="card-body">
                    ...
                    <blockquote class="blockquote">
                      <p>
                        "I really don´t get what they do. Something with Crypto,
                        NFT´s, SaaS and Cyber Security. Maybe an App for
                        Kids...? But they have this nice website...so who cares
                        what they do as long as they are good at it."
                      </p>
                    </blockquote>
                    <div class="d-flex justify-content-between border-top pt-3">
                      <p class="card-text">
                      ...
                      <img
                        src="/assets/img/webp/person3.webp"
                        width="48"
                        height="48"
                        class="rounded-circle"
                        alt=""
              ...
              <div class="col-12 col-lg-6 col-xl-4">
                <div class="card p-4 mt-3 border-0" data-aos="fade-left">
                  <div class="card-body">
                    ...
                    <blockquote class="blockquote">
                      <p>
                        "I don´t know if they are good at what they do. But they
                        have nice coffee and a shiny brand new startup office
                        with bikes on the wall and all that stuff."
                      </p>
                    </blockquote>
                    <div class="d-flex justify-content-between border-top pt-3">
                      <p class="card-text">
                      ...
                      <img
                        src="/assets/img/webp/person8.webp"
                        width="48"
                        height="48"
                        class="rounded-circle"
                        alt=""
              ...
              <div class="col-12 col-lg-6 col-xl-4">
                <div class="card p-4 mt-3 border-0" data-aos="fade-right">
                  <div class="card-body">
                    ...
                    <blockquote class="blockquote">
                      <p>
                        "Its not good at all but I give it five stars because I
                        killed (accidentally) the CEO´s cat with a lawnmover."
                      </p>
                    </blockquote>
                    <div class="d-flex justify-content-between border-top pt-3">
                      <p class="card-text">
                      ...
                      <img
                        src="/assets/img/webp/person14.webp"
                        width="48"
                        height="48"
                        class="rounded-circle"
                        alt=""
              ...
              <div class="col-12 col-lg-6 col-xl-4">
                <div class="card p-4 mt-3 border-0" data-aos="fade-up">
                  <div class="card-body">
                    ...
                    <blockquote class="blockquote">
                      <p>
                        "I´am just a guy who uploads his picture to unsplash.com
                        so that others can use me as placeholder for stupid
                        sample avatars. I don´t even know that my face is on
                        this website."
                      </p>
                    </blockquote>
                    <div class="d-flex justify-content-between border-top pt-3">
                      ...
                      <img
                        src="/assets/img/webp/person13.webp"
                        width="48"
                        height="48"
                        class="rounded-circle"
                        alt=""
              ...
              <div class="col-12 col-lg-6 col-xl-4">
                <div class="card p-4 shadow mt-3 border-0" data-aos="fade-left">
                  <div class="card-body">
                    ...
                    <blockquote class="blockquote">
                      <p>
                        "Okay, okay, I give it five stars. But do you know what:
                        There is a infinit number of stars out there. So five
                        means nothing."
                      </p>
                    </blockquote>
                    <div class="d-flex justify-content-between border-top pt-3">
                      ...
                      <img
                        src="/assets/img/webp/person18.webp"
                        width="48"
                        height="48"
                        class="rounded-circle"
                        alt=""
            ...
            <div class="d-flex">
              ...
              <div class="col-md-9 flex-fill">
                ...
                <p>
                  ...
                  door steps. Of course in time and to the right adress. But we
                  have no products...
                </p>
              </div>
            </div>
            ...
            <div class="d-flex">
              ...
              <div class="col-md-9 flex-fill">
                ...
                <p>
                  ...
                  ordered. But you can´t order anything here, so we can give you
                  a 100% gurantee that anything would be great!
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div class="d-flex">
              ...
              <div class="col-md-9 flex-fill">
                ...
                <p>
                  Okay, we have this crazy online support form. Fill it out and
                  the content will be mailed to you as PDF. Print it out. Than
                  send it via Fax to our super duper hidden Fax number.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-12 col-lg-8 text-center">
          <h3 class="fs-2 fw-light">
            Stay in touch with our<span class="fw-bold"> monthly and free</span>
            newsletter!
          </h3>
        </div>
        <div class="col-12 col-lg-8 text-center">
